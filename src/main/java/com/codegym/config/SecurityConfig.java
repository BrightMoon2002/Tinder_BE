...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/", "/api/login", "/mails", "/mails/send", "/api/bills", "/api/accounts*","/api/genders","/api/staffs*","/api/staffs/**","/api/avatar*","/api/checkers/**", "/api/bills/view/**", "/api/bills/editStatus/**", "/api/bills/showByStaff/**", "/api/bills/showByChecker/**", "/api/bills/cancelStatus/**", "/api/bills/setStatusCompleted/**", "/api/bills/setStatusRequestMoney/**", "/api/accounts/unBlockAccount/**", "/api/accounts/blockAccount/**").permitAll()
